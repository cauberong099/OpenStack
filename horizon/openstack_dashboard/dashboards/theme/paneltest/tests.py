...
INDEX_URL = reverse('horizon:project:paneltest:index')
...
class UsageViewTests(test.TestCase):
    ...
    def _test_usage(self, nova_stu_enabled):
        ...
        res = self.client.get(reverse('horizon:project:paneltest:index'))
        usages = res.context['usage']
        self.assertTemplateUsed(res, 'project/paneltest/usage.html')
    ...
    def test_unauthorized(self):
        ...
        url = reverse('horizon:project:paneltest:index')
    ...
    def _test_usage_csv(self, nova_stu_enabled=True):
        ...
        res = self.client.get(reverse('horizon:project:paneltest:index') +
                              "?format=csv")
        self.assertTemplateUsed(res, 'project/paneltest/usage.csv')
