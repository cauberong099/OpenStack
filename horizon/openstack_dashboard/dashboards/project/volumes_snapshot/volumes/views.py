...
from openstack_dashboard.dashboards.project.volumes_snapshot \
...
class DetailView(tabs.TabView):
    ...
    template_name = 'project.volumes_snapshot/volumes/detail.html'
...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'project.volumes_snapshot/volumes/create.html'
...
class ExtendView(forms.ModalFormView):
    ...
    template_name = 'project.volumes_snapshot/volumes/extend.html'
...
class CreateSnapshotView(forms.ModalFormView):
    ...
    template_name = 'project.volumes_snapshot/volumes/create_snapshot.html'
...
class UploadToImageView(forms.ModalFormView):
    ...
    template_name = 'project.volumes_snapshot/volumes/upload_to_image.html'
...
class CreateTransferView(forms.ModalFormView):
    ...
    template_name = 'project.volumes_snapshot/volumes/create_transfer.html'
    success_url = reverse_lazy('horizon:project:volumes:volumes_tab')
...
class AcceptTransferView(forms.ModalFormView):
    ...
    template_name = 'project.volumes_snapshot/volumes/accept_transfer.html'
    success_url = reverse_lazy('horizon:project:volumes:volumes_tab')
...
class ShowTransferView(forms.ModalFormView):
    ...
    template_name = 'project.volumes_snapshot/volumes/show_transfer.html'
    success_url = reverse_lazy('horizon:project:volumes:volumes_tab')
...
class UpdateView(forms.ModalFormView):
    ...
    template_name = 'project.volumes_snapshot/volumes/update.html'
    submit_label = _("Save")
...
class EditAttachmentsView(tables.DataTableView, forms.ModalFormView):
    ...
    template_name = 'project.volumes_snapshot/volumes/attach.html'
...
class RetypeView(forms.ModalFormView):
    ...
    template_name = 'project.volumes_snapshot/volumes/retype.html'
...
class EncryptionDetailView(generic.TemplateView):
    template_name = 'project.volumes_snapshot/volumes/encryption_detail.html'
