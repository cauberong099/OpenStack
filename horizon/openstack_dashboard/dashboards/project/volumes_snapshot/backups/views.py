...
class CreateBackupView(forms.ModalFormView):
    ...
    template_name = 'project.volumes_snapshot/backups/create_backup.html'
...
class BackupDetailView(tabs.TabView):
    ...
    template_name = 'project.volumes_snapshot/backups/detail.html'
...
class RestoreBackupView(forms.ModalFormView):
    ...
    template_name = 'project.volumes_snapshot/backups/restore_backup.html'
